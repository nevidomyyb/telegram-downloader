...
with TelegramVideoDownloader.client:
    ...
    TelegramVideoDownloader.client.loop.run_until_complete(TelegramVideoDownloader.download_videos(compact_map=compact_map, compact=True))
